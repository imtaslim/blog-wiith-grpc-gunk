...
type CategoryServiceClient interface {
	...
	Gets(ctx context.Context, in *GetsCategoryRequest, opts ...grpc.CallOption) (*GetsCategoryResponse, error)
}
...
func (c *categoryServiceClient) Gets(ctx context.Context, in *GetsCategoryRequest, opts ...grpc.CallOption) (*GetsCategoryResponse, error) {
	out := new(GetsCategoryResponse)
	err := c.cc.Invoke(ctx, "/category.CategoryService/Gets", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type CategoryServiceServer interface {
	...
	Gets(context.Context, *GetsCategoryRequest) (*GetsCategoryResponse, error)
...
func (UnimplementedCategoryServiceServer) Gets(context.Context, *GetsCategoryRequest) (*GetsCategoryResponse, error) {
...
func _CategoryService_Gets_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetsCategoryRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CategoryServiceServer).Gets(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/category.CategoryService/Gets",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CategoryServiceServer).Gets(ctx, req.(*GetsCategoryRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var CategoryService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "Gets",
			Handler:    _CategoryService_Gets_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "blog-gunk/gunk/v1/category/all.proto",
}
